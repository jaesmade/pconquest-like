...
export const SPECIES: Record<string, Species> = {
  ...
  charmander: { name: 'Charmander', types: ['Fire'], ability: 'Blaze', stats: [58, 52, 43, 60, 50, 5, 3], moves: ['ember', 'tackle'], learn: { 12: 'sunnyDay' }, mega: { stone: 'Charizardite X', name: 'Mega Charizard', ability: 'Tough Claws', stats: [90, 96, 78, 86, 75, 7, 4], mobility: { fly: true } } },
};
